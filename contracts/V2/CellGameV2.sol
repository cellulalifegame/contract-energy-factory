...
import {LifeV2 as Life} from "./LifeV2.sol";
import "../Helps.sol";

contract CellGameV2 is ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function batchCreateLife(uint256[][][] calldata genes, uint256[] calldata quantitys) public payable returns(uint256[] memory token_ids) {
        ...
        for (uint256 i = 0; i < genes.length; ++i) {
            ...
            require( cellsPositions_.length >= 2 && cellsPositions_.length <= 9, "can only use 2-9 cells!");
